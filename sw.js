...
const CACHE_VERSION = 'tomatofarm-v20260623z12-stats-life-zone-tab-router';
...
const STATIC_ASSETS = [
  ...
  './home/cheers-card.js',
  './render-workout.js',
  './render-workout.js?v=20260623z1-current-week-add',
  './workout/index.js',
  './workout/index.js?v=20260623z1-current-week-add',
  './workout/state.js',
  './workout/save.js',
  ...
  './test-mode-v2.css',
  './test-mode-v2.css?v=20260621z1-helper-chip-scope',
  './workout/test-v2/entry.js',
  './workout/test-v2/entry.js?v=20260623z1-current-week-add',
  './workout/test-v2/board-core.js',
  './workout/test-v2/board-core.js?v=20260623z1-current-week-add',
  './workout/test-v2/board-render.js',
  './workout/test-v2/board-render.js?v=20260623z1-current-week-add',
  './workout/test-v2/onboarding.js',
  './workout/test-v2/onboarding.js?v=20260623z1-current-week-add',
